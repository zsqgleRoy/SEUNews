  ...
  <footer id="footer0820">
      ...
      <div class="footer-header">
        <div class="footer-logo">
          ...
          -->
              <img src="../components/icons/CXXYlogo.png" alt="SEU_logo" height="30">
          </div>
          <div class="footer-title">东南新闻网</div>
      </div>
      <div class="footer-container">
          ...
          <div class="info-column">
              ...
              <ul>
                  ...
                  <li>东南新闻广播电视总台 东广网</li>
                  <li>东南新闻网开发小组&nbsp;&nbsp;版权所有</li>
              </ul>
              <div class="other">
                  <span>
                      ...
                      <a href="https://bszs.conac.cn/" target="_blank">
                          <img src="http://www.moe.gov.cn/images/red.png" alt="" height="45px">
                      </a>
                  </span>
              </div>
          </div>
              ...
              <ul>
                  <li>
                      <a href="https://www.seu.edu.cn/" target="_blank">
                          <img src="./icons/seu.png" alt="cnr cxxy logo" height="32">
                          <span>东南大学</span>
                      </a>
                  </li>
                  <li>
                      <a href="http://cxxy.seu.edu.cn/" target="_blank">
                          <img src="./icons/seu.png" alt="cxxy logo" height="32">
...
.link-column ul li a:hover {
  color: #ffd700;
  background-color: rgba(215, 21, 31, 0.5);
}
