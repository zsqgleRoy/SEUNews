    ...
    <div class="payment-container">
        <div class="payment-card">
            ...
            <div class="instruction-container">
                <p class="instruction-text">请使用数字人民币APP扫描二维码</p>
            </div>
...
const qrcodeImages = [
    'src/assets/imges/https___qr.pbcdci.cn_002020000100000555480815933367.png',
    'src/assets/imges/https___qr.pbcdci.cn_002020000100000555480815933367.png',
    'src/assets/imges/https___qr.pbcdci.cn_002020000100000555480815933367.png',
    'src/assets/imges/https___qr.pbcdci.cn_002020000100000555480815933367.png',
    'src/assets/imges/https___qr.pbcdci.cn_002020000100000555480815933367.png',
...
.payment-container {
    background-image: url("http://192.168.124.5:8080/static/news-images/20250402001210903_2840244c.png");
    user-select: none;
    width: 100vw;
    height: 100vh;
...
.icon {
    ...
    min-height: 32px;
    text-align: center;
    background-image: url("http://192.168.124.5:8080/static/news-images/20250402000944211_1bd0be06.png");
